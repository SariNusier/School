...
\begin{enumerate}[label=(\alph*)]
	\item Without PCA
		...
		\includegraphics[scale=0.5]{plots/a/inertias.png}
		\includegraphics[scale=0.5]{plots/a/sils.png}
		\includegraphics[scale=0.5]{plots/a/cals.png}
	\item PCA
	
	2 Components
		
		\includegraphics[scale=0.5]{plots/b/intertias-0.png}
		\includegraphics[scale=0.5]{plots/b/sils-0.png}
		\includegraphics[scale=0.5]{plots/b/cals-0.png}
